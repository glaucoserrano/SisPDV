...
namespace SisPDV.Infrastructure.Migrations
{
    ...
    [Migration("20250818153733_altertableOriginOrderandOrderItem")]
    partial class altertableOriginOrderandOrderItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.Config", b =>
                {
                    ...
                    b.Property<bool>("UsePrintSector")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.StockMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SisPDV.Domain.Entities.Product", b =>
                {
                    b.HasOne("SisPDV.Domain.Entities.Category", "Category")
                        .WithMany()
                    ...
                    b.HasOne("SisPDV.Domain.Entities.PrintSector", "PrinterSector")
                        .WithMany()
                        .HasForeignKey("PrinterSectorId");

                    b.HasOne("SisPDV.Domain.Entities.ProductTypes", "ProductType")
                        .WithMany()
